...
The UI for this exists in ai-elements; the storage behind it does not exist anywhere else ([vercel/ai#2929](https://github.com/vercel/ai/issues/2929), open since 2024).
